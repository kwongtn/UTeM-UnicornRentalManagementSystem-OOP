	...
	public void actionPerformed(ActionEvent event) {
		...
		if (source == btnDelete) {
			...
			if (size == 0) {
				...
				try {
					if (UnicornManager.deleteUnicorn(id) != -1) {
						JOptionPane.showMessageDialog(this, "Rental has been deleted.", "Success",
								JOptionPane.INFORMATION_MESSAGE);
						reset();
					} else
						JOptionPane.showMessageDialog(this, "Unable to delete Rental.", "Unsuccessful",
